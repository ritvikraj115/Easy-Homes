    ...
    <section className="py-20 bg-[#DFE5EF]">
      <div className="container mx-auto px-4 md:!px-12">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 font-poppins">What Our Customers Say</h2>
          <p className="text-gray-600 mt-2 font-inter">
            Real stories from satisfied customers who found their perfect plot with Easy Homes
          </p>
        </div>
